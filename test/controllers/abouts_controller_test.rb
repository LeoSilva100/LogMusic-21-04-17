...
class AboutsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create about" do
    assert_difference('About.count') do
      post abouts_url, params: { about: { band: @about.band, description: @about.description } }
    end
  ...
  test "should update about" do
    patch about_url(@about), params: { about: { band: @about.band, description: @about.description } }
