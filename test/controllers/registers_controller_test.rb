...
class RegistersControllerTest < ActionController::TestCase
  ...
  test "should create register" do
    assert_difference('Register.count') do
      post :create, register: { age: @register.age, city: @register.city, instrument: @register.instrument, name: @register.name, state: @register.state, street: @register.street, stylo: @register.stylo }
    end
  ...
  test "should update register" do
    patch :update, id: @register, register: { age: @register.age, city: @register.city, instrument: @register.instrument, name: @register.name, state: @register.state, street: @register.street, stylo: @register.stylo }
    assert_redirected_to register_path(assigns(:register))
  end
